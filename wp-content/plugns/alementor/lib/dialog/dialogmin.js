    ...
    y.Widget = function(n) {
        function e(t, e) {
            ...
            if (p.isFunction(t))
                ...
                if (!n[t])
                    throw "Reference Error: The effect " + t + " not found";
                n[t].apply(n, e)
            }
        }
        function i(t) {
            if (!f(t)) {
                if (a.hide.onClick) {
                    if (p(t.target).closest(a.selectors.preventClose).length)
                        return
        ...
        function t() {
            ...
            t.forEach(function(t) {
                ...
                a.hide.onOutsideContextMenu && t[0].removeEventListener("contextmenu", o, !0),
        ...
        this.addElement = function(t, e, n) {
            ...
            return n = n ? n + " " : "",
            n = (n += a.classes.globalPrefix + "-" + t) + (" " + a.classes.prefix + "-" + t),
            e.addClass(n),
            e
        }
        ,
        ...
        this.hide = function() {
            if (c.isVisible())
                ...
                e("hide", arguments),
                t(),
                a.preventScroll && c.getElements("body").removeClass(a.classes.preventScroll),
                c.trigger("hide"),
                c
        }
        ,
        this.init = function(t, e) {
            ...
            if (t instanceof y.Instance)
                ...
                a.closeButton && (a.closeButtonClass && (a.closeButtonOptions.iconClass = a.closeButtonClass),
                n = p("<a>", a.closeButtonOptions.attributes),
                i = p(a.closeButtonOptions.iconElement).addClass(a.closeButtonOptions.iconClass),
                n.append(i),
        ...
        this.off = function(t, e) {
            return u[t] && (e ? -1 !== (e = u[t].indexOf(e)) && u[t].splice(e, 1) : delete u[t]),
            c
        }
        ,
        this.refreshPosition = function() {
            var t, e, n, i, o, s, r;
            a.position.enable && (t = p.extend({}, a.position),
            d[t.of] && (t.of = d[t.of]),
            t.of || (t.of = window),
            a.iframe && (e = t).my && (n = /([+-]\d+)?$/,
            i = d.iframe.offset(),
        ...
        this.setSettings = function(t, e) {
            return jQuery.isPlainObject(e) ? p.extend(!0, a[t], e) : a[t] = e,
            c
        }
        ,
        this.show = function() {
            ...
            t.forEach(function(t) {
                ...
                a.hide.onOutsideContextMenu && t[0].addEventListener("contextmenu", o, !0),
    ...
    y.addWidgetType("buttons", {
        ...
        addButton: function(t) {
            ...
            var n = this
              ...
              , o = (s += i.classes.globalPrefix + "-button",
